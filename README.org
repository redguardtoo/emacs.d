...
If you prefer the method described in the section "Install stable version in easiest way", skip everything below this line.
...
Ensure that the 'init.el' contained in this repo ends up at ~/.emacs.d/init.el and old ~/.emacs *IS REMOVED*.
