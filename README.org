...
- I do *NOT* re-define key bindings usually, so original key bindings are still there
- Usable in [[https://packages.debian.org/emacs-nox][emacs-nox]] 
- Many programming languages supported (C/C++/Java/Ruby/Perl/Python/C#/Lua/Javascript ...)
...
* Report bug
Check [[http://www.emacswiki.org/emacs/][EmacsWiki]] and my FAQ at first, please.
