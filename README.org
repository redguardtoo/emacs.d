...
It's not recommdned for daily usage because the third party packages are not optimized for latest Emacs.
...
** Emacs 25.1
Version 3.1 is the last version to support =Emacs 25.1+=
