...
You can specify the ignore regex like =!keyword1= in =ivy=. If you want to ignore multiple keywords, you *must* use syntax like =!keyword1\|!keyword2=. As I tested in cousnel v0.9.1, non of its grep commands supports ignore syntax *reliably*. So I suggest using =my-grep= instead.
