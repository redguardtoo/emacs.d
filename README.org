...
* Checklist
- Tested with Emacs 24.3, 24.4, 24.5, 25.3 on Linux/Windows/Cygwin/Mac (I will stop 24.3 support at <2018-01-01>)
...
[[https://github.com/abo-abo/hydra][Hydra]] is use to define keybindings when evil-mode is disabled. See =~/.emacs.d/lisp/init-hydra.el= for details.
