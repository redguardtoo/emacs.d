...
** Editing Emacs Lisp
We use [[https://github.com/abo-abo/lispy/tree/0.26.0][lispy]] and [[https://github.com/noctuid/lispyville][lispyville]] when editing Emacs Lisp. So you need be familiar with their key bindings.
* Tips
