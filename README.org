...
The good news is my setup optimizes the multi-edit workflow. After =M-x my-grep= (or pregre ",qq"), you only need press =C-c C-o= once to use =wgrep-mode=, and you can edit text (for example, delete lines) in =wgrep-mode= without any futher key presssing.
** js2-mode
