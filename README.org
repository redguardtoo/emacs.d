...
- Git skills are *extremely useful* for maintaining your emacs.d. The book [[https://git-scm.com/book/en/][Pro Git]] has everything. Please read the chapters "Git Basics", "Git Branching", "Git Tools" at minimum.
* Report bug
