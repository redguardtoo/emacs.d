...
- I intentionally make packages from [[http://melpa.org][MELPA]] *invisible* by default. You can modify variable =melpa-include-packages= in =~/.emacs.d/lisp/init-elpa.el= to install those packages
...
Please note there is *NO unified way* to enable color theme because there two types of color theme. You need read color theme's documentation at first.
...
If two plugins conflict, the more frequently used plugin takes priority.
...
Please reading [[https://bitbucket.org/lyro/evil/raw/f2648b841f9bcded8764ce63410065d2b8c5f856/doc/evil.pdf][its PDF manual]] before using evil-mode.
...
- Make sure your code is syntax correct
...
Emacs is *portable* on any platform. Please read "Install Emacs at home directory" for how.
* Tips
