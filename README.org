...
- If you use unicode in the setup, please make sure your locale is *UTF-8 compatible*. For example, I type `locale` in shell, and the output contains string `zh_CN.UTF-8`
