...
* Checklist
- Emacs 28 or higher version is required
- Please read FAQ to disable [[http://www.vim.org][Vim]] key bindings
- Please read section "Key bindings" to learn key bindings
- Windows users had better download the version with dependencies bundled. For example, download "emacs-28.2-x86_64.zip" instead of "emacs-28.2-x86_64-no-deps.zip"
