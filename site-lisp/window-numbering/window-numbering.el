...
(defvar window-numbering-keymap
  (let ((map (make-sparse-keymap)))
    (define-key map "\C-x\M-0" 'select-window-0)
    (define-key map "\C-x\M-1" 'select-window-1)
    (define-key map "\C-x\M-2" 'select-window-2)
    (define-key map "\C-x\M-3" 'select-window-3)
    (define-key map "\C-x\M-4" 'select-window-4)
    (define-key map "\C-x\M-5" 'select-window-5)
    (define-key map "\C-x\M-6" 'select-window-6)
    (define-key map "\C-x\M-7" 'select-window-7)
    (define-key map "\C-x\M-8" 'select-window-8)
    (define-key map "\C-x\M-9" 'select-window-9)
    map)
