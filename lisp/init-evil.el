...
(define-key evil-normal-state-map (kbd "C-]") 'fastctags-code-nav-find-tag-at-point)
(define-key evil-visual-state-map (kbd "C-]") 'fastctags-code-nav-find-tag-at-point)
...
(my-comma-leader-def
  ...
  "rt" 'fastctags-code-nav-recent-tar
  "ft" 'fastctags-code-nav-find-tag
